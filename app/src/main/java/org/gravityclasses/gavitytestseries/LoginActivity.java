...
//
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pagerAdapter=new SlideShowPagerAdapter(this,list);
...
//        populateAutoComplete();
    ...
    public void makeRequest(final String email, final String password){
        // Instantiate the RequestQueue.
        mRequestQueue = Volley.newRequestQueue(this);
        String url ="https://gravityclasses.in/test_series/scripts/login.php";
