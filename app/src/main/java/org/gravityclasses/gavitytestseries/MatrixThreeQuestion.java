...
public class MatrixThreeQuestion extends Question {
    public Vector<QOption> options;
    Vector<QuestionItem> qi;


    public MatrixThreeQuestion(int id, Vector<QuestionItem> qi, String subject, String topic, String difficulty, String marking, String correctAns, Solution s)
    {
        this.qi=qi;
