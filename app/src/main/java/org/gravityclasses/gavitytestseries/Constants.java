...
public class Constants {
    ...
    final static String LOGIN_URL= "https://gravityclasses.in/test_series/scripts/login.php";
    final static String GET_TESTS_URL= "https://gravityclasses.in/test_series/scripts/get_tests.php";
